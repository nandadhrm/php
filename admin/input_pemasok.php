...
<body>
 <div class="modal-body">
          <form action="index.php?page=simpan_pemasok" name="modal_popup" enctype="multipart/form-data" method="POST">
            
                <div class="form-group" style="padding-bottom: 20px;">
                  <label for="Modal Name">ID Pemasok</label>
                  <input type="text" name="id_pemasok"  class="form-control" placeholder="Id Pemasok" required/>
                </div>
