            ...
            <script>
                ...
                $(function(){
                    ...
                    $("#tambah").click(function(){
                        ...
                        }else if(jumlah_jual > jumlah_obat){
                            alert("Stok Obat Ditak Memenuhi");
                            $("#jumlah_jual").focus();
                            exit();
                        ...
                        $.ajax({
                            url:"pk.php",
                            data:"op=tambah&kode_obat="+kode_obat+"&nama_obat="+nama_obat+"&harga_jual_obat="+harga_jual_obat+"&jumlah_jual="+jumlah_jual,
                            cache:false,
                            success:function(msg){
                                if(msg=="sukses"){
                ...
                switch($p){
                    default:
                        echo "<table class='table table-bordered'>
                            <tr>
                                <td colspan='3'><a href='?page=jual&act=tambah' class='btn btn-primary'>Input Transaksi</a></td>
                            </tr>
                                <tr>
                                    <td>No.Nota</td>
                                    <td>Tanggal</td>
                                ...
                                while($r=mysqli_fetch_array($query)){
                                    echo "<tr>
                                            <td><a href='?page=jual&act=detail&nota=$r[nonota]'>$r[nonota]</a></td>
                                            <td>$r[tanggal]</td>
                                            <td>$r[total]</td>
                                            <td><a href='?page=jual&act=detail&nota=$r[nonota]'>Cetak Nota</a></td>
                                        </tr>";
                                }
                                echo"</table>";
                    ...
                    case "tambah":
                        ...
                        echo "<div class='navbar-form pull-right'>
                            ...
                            <input type="text" id="harga_jual_obat" placeholder="Harga" class="span2" readonly>
                            <input type="text" id="jumlah_obat" placeholder="stok" class="span1" readonly>
                            <input type="text" id="jumlah_jual" placeholder="Jumlah Beli" class="span1">
                    ...
                    case "detail":
                        ...
                        $nota=$_GET['nota'];
                        $query=mysqli_query($con,"select penjualan.nonota,detailpenjualanjual.kode_obat,obat.nama_obat,
                                           detailpenjualanjual.harga_jual_obat,detailpenjualanjual.jumlah_jual,detailpenjualanjual.subtotal
                                           from detailpenjualanjual,penjualan,obat
                                           where penjualan.nonota=detailpenjualanjual.nonota and obat.kode_obat=detailpenjualanjual.kode_obat
                                           and detailpenjualanjual.nonota='$nota'");
